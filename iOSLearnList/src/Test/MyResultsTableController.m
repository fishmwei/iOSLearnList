...
@interface MyResultsTableController ()

@end

@implementation MyResultsTableController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    id data = [self.filteredProducts objectAtIndex:indexPath.row];
